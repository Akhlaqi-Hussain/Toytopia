      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-3">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl py-3">
          ...
          <div className="flex items-center lg:order-2">
            <Link href={'/main/dashboard'} className="text-white bg-gray-800 font-semibold rounded-full text-sm px-5 py-2.5 me-2 hover:bg-gray-100 hover:text-black">Login</Link>
            <button
              onClick={toggleMenu}
              type="button"
